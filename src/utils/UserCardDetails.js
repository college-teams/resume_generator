export const data = [
  {
    id: 1,
    name: "Waqas Akbar",
    role: "Transformation Program Manager at Google",
    image: require("../assets/usr1.webp").default,
    dataSrc:require("../assets/compression/usr1_10_11zon.jpg").default,
    showMore: false,
    description:
  ...
  },
  {
    id: 2,
    name: "Brandon Klein",
    role: "Senior Product Marketing Manager at Badu Networks",
    image: require("../assets/usr2.webp").default,
    dataSrc:require("../assets/compression/usr2_11_11zon.jpg").default,
    showMore: false,
    description:
  ...
  },
  {
    id: 3,
    name: "Linn Mollberg",
    role: "SJunior Marketing Assistant",
    image: require("../assets/usr3.webp").default,
    dataSrc:require("../assets/compression/usr3_12_11zon.jpg").default,
    showMore: false,
    description:
  ...
  {
    id: 4,
    name: "Shylean Keshwani",
    role: "Senior Product Marketing Manager at Badu Networks",
    image: require("../assets/usr4.webp").default,
    dataSrc:require("../assets/compression/usr4_13_11zon.jpg").default,
    showMore: false,
    description:
      "Absolutely love Novorésumé! The layouts are phenomenal and enhancement hints that the tool provides you with is like having your own personal resume consultant! So much better than spending hours creating my own design files. Even better, the $16 you pay for the month doesn't auto-renew! Seems like a company that really wants to provide you with value instead of just take your money.",
  },
  {
    ...
    name: "Yuki Lin",
    role: "Senior Product Marketing Manager at Badu Networks",
    image: require("../assets/usr5.webp").default,
    dataSrc:require("../assets/compression/usr5_14_11zon.jpg").default,
    showMore: false,
    description:
      "Absolutely love Novorésumé! The layouts are phenomenal and enhancement hints that the tool provides you with is like having your own personal resume consultant! So much better than spending hours creating my own design files. Even better, the $16 you pay for the month doesn't auto-renew! Seems like a company that really wants to provide you with value instead of just take your money.",
  },
  {
    ...
    name: "Hicham Berkouk",
    role: "Senior Product Marketing Manager at Badu Networks",
    image: require("../assets/usr6.webp").default,
    dataSrc:require("../assets/compression/usr6_15_11zon.jpg").default,
    showMore: false,
    description:
      "Absolutely love Novorésumé! The layouts are phenomenal and enhancement hints that the tool provides you with is like having your own personal resume consultant! So much better than spending hours creating my own design files. Even better, the $16 you pay for the month doesn't auto-renew! Seems like a company that really wants to provide you with value instead of just take your money.",
  },
